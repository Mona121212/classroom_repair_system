...
public class ServiceDeskDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ServiceDeskGlobalFeatureConfigurator.Configure();
        ServiceDeskModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ServiceDeskDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ServiceDeskResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ServiceDesk");

            options.DefaultResourceType = typeof(ServiceDeskResource);
        ...
        {
            options.MapCodeNamespace("ServiceDesk", typeof(ServiceDeskResource));
        });
    }
}
